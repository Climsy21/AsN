...
const ExpertiseSection = () => {
  const expertise = [
    ...
    },
    {
      ...
      features: ['Ancient tantric methods', 'Customized rituals', 'Spiritual empowerment', 'Energy cleansing'],
    ...
    },
    {
      ...
      features: ['Grand fire ceremony', 'Cosmic energy invocation', 'Universal peace', 'Collective prosperity'],
