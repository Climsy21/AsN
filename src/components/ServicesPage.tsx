          ...
          {isMobile ? (
            ...
            <>
              ...
              <nav className="flex items-center space-x-8">
                ...
                <span className="text-white font-semibold drop-shadow-lg">{t.header.services}</span>
                <button 
                  onClick={() => onNavigate('home')}
                  className="text-white/90 hover:text-white transition-colors duration-300 drop-shadow-lg"
                >
                    ...
                    <div className="space-y-4 md:space-y-6">
                      <div>
                        ...
                        <ul className="space-y-2">
                          {service.benefits && service.benefits[currentLanguage] && Array.isArray(service.benefits[currentLanguage]) && 
                            service.benefits[currentLanguage].map((benefit: string, benefitIndex: number) => (
