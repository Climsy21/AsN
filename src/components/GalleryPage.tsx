          ...
          {isMobile ? (
            ...
            <>
              ...
              <nav className="flex items-center space-x-8">
                ...
                <span className="text-white font-semibold drop-shadow-lg">{t.header.gallery}</span>
                <button 
                  onClick={() => onNavigate('home')}
                  className="text-white/90 hover:text-white transition-colors duration-300 drop-shadow-lg"
                >
      ...
      <main className="relative z-10 pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <span className="text-sm md:text-base">{t.gallery.backToHome}</span>
          </button>
          ...
          <div className="text-center mb-16">
            ...
            <div className="mt-8 text-white/60">
              <p className="text-sm md:text-base">
                {galleryImages.length} {t.gallery.sacredImages} • Click any image to view in full size
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
              <h2 className="text-2xl md:text-4xl font-bold text-white mb-6 drop-shadow-xl">
                {t.gallery.sacredMomentsCaptured}
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-white/70">{t.gallery.sacredImages}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-white mb-2">100+</div>
                  <div className="text-white/70">{t.gallery.ceremoniesDocumented}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-white mb-2">1000+</div>
                  <div className="text-white/70">{t.gallery.livesBlessed}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          <div className="relative max-w-7xl max-h-full">
            <img
              ...
              alt={galleryImages[selectedImage].alt[currentLanguage]}
              className="max-w-full max-h-[90vh] object-contain rounded-2xl shadow-2xl"
            />
            
            {/* Image info - removed title, only showing image number */}
